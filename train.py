...
data_path = r"/media/dgl/Elements/zsm/TEM_CS_VIDEO/TEMcode/train"
test_path1 = r"/media/dgl/Elements/zsm/TEM_CS_VIDEO/TEMcode/test"  # simulation data for comparison
...
rnn2 = backrnn().cuda()
first_frame_net=nn.parallel.DataParallel(first_frame_net)
rnn1=nn.parallel.DataParallel(rnn1)
rnn2=nn.parallel.DataParallel(rnn2)
